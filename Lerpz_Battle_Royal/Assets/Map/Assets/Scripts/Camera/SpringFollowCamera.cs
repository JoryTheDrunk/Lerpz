...
public class SpringFollowCamera : MonoBehaviour
{
    ...
    public float targetHeight = 100000.0f;
    ...
    void SetUpRotation(Vector3 centerPos, Vector3 headPos)
    {
        ...
        Ray centerRay = GetComponent<Camera>().ViewportPointToRay(new Vector3(.5f, 0.5f, 1));
        Ray topRay = GetComponent<Camera>().ViewportPointToRay(new Vector3(.5f, clampHeadPositionScreenSpace, 1));
